...
echo "4. Update homebrew/git-stashx.rb with:"
...
echo "   cp homebrew/git-stashx.rb homebrew-tap/Formula/"
echo "   cd homebrew-tap"
echo "   git add Formula/git-stashx.rb"
echo "   git commit -m \"Add git-stashx ${VERSION}\""
echo "   git push"
echo ""
echo "6. Test installation:"
echo "   brew tap ${GITHUB_USER}/tap"
echo "   brew install git-stashx"
echo ""
...
echo "3. Add Formula/git-stashx.rb"
